...
IMGUI_API void ImGui_ImplGlfw_MouseButtonCallback(GLFWwindow* window,
                                                  ...
                                                  int action,
                                                  int mods);
IMGUI_API void ImGui_ImplGlfw_ScrollCallback(GLFWwindow* window,
                                             double xoffset,
                                             double yoffset);
IMGUI_API void ImGui_ImplGlFw_KeyCallback(GLFWwindow* window,
                                          int key,
                                          int scancode,
                                          int action,
                                          int mods);
...
// You *might* use this code with a GL3/GL4 context but make sure you disable
// the programmable pipeline by calling "glUseProgram(0)" before
// ImGui::Render().
...
bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks) {
  ...
  io.RenderDrawListsFn =
      ImGui_ImplGlfw_RenderDrawLists;  // Alternatively you can set this to NULL
...
bool ImGui::BeginDock(const char* label,
                      bool* opened,
